...
class MakeRoutesCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:AdminRoutes {name}';
    ...
    {
        return __DIR__ . '/../../../stubs/admin.routes.stub';
    }
    ...
    */
    ...
    {
        return base_path('routes/admin').'/'.strtolower($this->getPluralClassName($this->argument('name'))).'.php';
    }
